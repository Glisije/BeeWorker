...
//        }
        ...
        var dynamicTableView : TableLayout = TableLayout(this.context)
        dynamicTableView = binding.tableView
...
//            (linearContainer.parent as?ViewGroup)?.removeView(linearContainer)
        linearContainer.addView(tableSetUp())
        scrollView.post {
            scrollView.fullScroll(View.FOCUS_DOWN)
...
//        }
    ...
    private fun tableSetUp(): TableLayout {
        // Create TableLayout
        ...
        editText1.inputType = InputType.TYPE_CLASS_DATETIME or InputType.TYPE_DATETIME_VARIATION_TIME
        ...
        editText2.inputType = InputType.TYPE_CLASS_DATETIME or InputType.TYPE_DATETIME_VARIATION_TIME
        ...
        button.text = getString(com.glisije.clearsalary.R.string.AddMoreSettings)
